...
public class GQLKPSPublicSoap
{
    ...
    public GQLKPSPublicSoap(){}

    public GQLKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public GQLKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        GQLExtendedSoapSerializationEnvelope envelope= new GQLExtendedSoapSerializationEnvelope(GQLExtendedSoapSerializationEnvelope.VER11);
