package com.mernis.backend.mernisAPI;
//----------------------------------------------------
//
...
public class GQLKPSPublicSoap12
{
    interface GQLIWcfMethod
    {
        GQLExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(GQLExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public GQLKPSPublicSoap12(){}

    public GQLKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public GQLKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    protected GQLExtendedSoapSerializationEnvelope createEnvelope()
    {
        GQLExtendedSoapSerializationEnvelope envelope= new GQLExtendedSoapSerializationEnvelope(GQLExtendedSoapSerializationEnvelope.VER12);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,GQLExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,GQLExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new GQLIWcfMethod()
        {
            @Override
            public GQLExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                GQLExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(GQLExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(GQLIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        GQLExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,GQLExtendedSoapSerializationEnvelope envelope)
    {
