...
public class GQLExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(GQLDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new GQLStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static GQLDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static GQLDateTimeConverter dateTimeConverter = new GQLStandardDateTimeConverter();

    public GQLExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public GQLExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new GQLMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=GQLHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public SoapObject GetSoapObject(Element detailElement) {
        ...
        catch (java.lang.Exception e)
        {
			if(enableLogging)
			{
				//android.util.Log.e(GQLExtendedSoapSerializationEnvelope.TAG,"Error occured",e);
			}
        }
        return null;
    }
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,GQLExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=GQLHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
